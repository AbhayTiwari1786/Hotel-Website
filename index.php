...
<html lang="en">
<head>
<title>Nirmal Homestay And Cottages</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:abhaytiwari1786@gmail.com"></a>abhaytiwari1786@gmail.com</li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91-7579034461</li>
				</ul>
			</div>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Nirmal <span>Homestay</span><p class="logo_w3l_agile_caption">Devotion Embeded In Hospitality</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Nirmal  <span>Homestay</span></h4>
										<img src="hotelpics/hotel2.jpg" alt=" " class="img-responsive">
										<h5>Experience Divinity With Hospitality</h5>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Nirmal Homestay And Cottages</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">River View Balcony</h4>
							<span class="cbp-ig-category">Nirmal Homestay And Cottages</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">Cafeteria</h4>
							<span class="cbp-ig-category">Nirmal Homestay And Cottages</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">Cab Services</h4>
							<span class="cbp-ig-category">Nirmal Homestay And Cottages</span>
						</div>
					</li>
				</ul>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Nirmal Homestay And Cottages</h3> 
						   ...
						   <img src="hotelpics/hotel8.jpg" class="img-responsive" alt="Hair Salon">
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="hotelpics/papa.jpg" style ="height: 120px "alt=" " class="img-responsive" />
					</li>
					<li>
					...
					<li>
						<img src="hotelpics/meenu.jpg" style ="height: 120px " alt=" " class="img-responsive" />
					</li>
					</ul>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Abhay Tiwari</h4>
							<span>Accomodation Manager</span>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis.Lorem ipsum dolor .</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
		 ...
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g1.jpg" class="swipebox"><img src="images/g1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Nirmal Homestay And Cottages</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				</a>
				</div>
				<div class="col-md-3 gallery-grid gallery1">
					<a href="hotelpics/hotel4.jpg" class="swipebox"><img src="hotelpics/hotel4.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Nirmal Homestay And Cottages</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
				...
				<form  method="post" name="sentMessage" id="contactForm" >
                    ...
                    <div class="control-group form-group">
                       ...
                       <div class="control-group form-group">
                            ...
                            <input type="text area" style="height: 150px; width: 474px" class="form-control" name="Message" id="email" required >
							<p class="help-block"></p>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91-7579034461</p>
			<p class="contact-agile1"><strong>Phone :</strong>+91-9411197348</p>
			<p class="contact-agile1"><strong>Phone :</strong>+91-8006817268</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:abhaytiwari1786@gmail.com">abhaytiwari1786@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong>HNo. 29A Kainchi Dham Bhowali District Nainital Uttrakhand-263132</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 Abhay tiwari . All Rights Reserved | Design by <a href="index.php">Abhay Tiwari</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
